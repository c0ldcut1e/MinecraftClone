...
void UIControl_Label::render()
{
    ...
    if (m_shadow)
    {
        font->draw(m_text, textX + 1.0f, textBaselineY + 1.0f, fontScale, 0xFF484848);
    }
...
void UIControl_Label::resizeHorizontal(float) {}

void UIControl_Label::resizeVertical(float) {}
