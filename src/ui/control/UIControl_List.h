...
public:
    ...
    virtual void resizeVertical(float padding = 24.0f);
    virtual void resizeHorizontal(float padding = 24.0f);

protected:
    void syncPanel();
    virtual bool shouldProcessControl(const UIControl *control) const;
