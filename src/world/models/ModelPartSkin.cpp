...
ModelPartSkin::ModelPartSkin(const std::string &texturePath, int textureWidth, int textureHeight)
    : m_texturePath(texturePath), m_textureWidth(textureWidth), m_textureHeight(textureHeight)
{}
